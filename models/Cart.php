...
class Cart extends model {
	...
	public function shippingCalculate($cepDestination) {
		...
		//limitacoes estabelecidas pelos correios caso ultrapasse colocamos manualmente
		if($soma > 200) {
			$nVlComprimento = 66;
			$nVlAltura = 66;
			$nVlLargura = 66;
		...
		//processo de envio com a biblioteca Curl
